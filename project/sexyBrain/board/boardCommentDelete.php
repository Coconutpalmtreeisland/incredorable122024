...
// 댓글 작성자 ID 가져오기
$sql = "SELECT memberId FROM sexyComment WHERE commentId = {$commentId} AND boardId = {$boardId}";
...
$sql = "DELETE FROM sexyComment WHERE commentId = {$commentId} AND boardId = {$boardId}";
$result = $connect->query($sql);
